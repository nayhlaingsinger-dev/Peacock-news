                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    <div class="card card-secondary">
                                        ...
                                        <div class="card-body">                                            
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-sm-12">
                                                    <label>{{ __('native_ads_mode') }}</label>
                                                    <div>
                                                        <input type="checkbox" id="native_ads" name="native_ads" class="status-switch" @if ($setting['native_ads_mode'] == '1') checked @endif>
                                                        <input type="hidden" id="native_ads_mode" name="native_ads_mode" value="{{ $setting['native_ads_mode'] ? $setting['native_ads_mode'] : '0' }}">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 col-sm-12">
                                                    <label>{{ __('native_ads_interval') }} (e.g. 4 or 5)</label>
                                                    <input type="number" name="native_ads_interval" class="form-control" value="{{ $setting['native_ads_interval'] ? $setting['native_ads_interval'] : '4' }}" />
                                                </div>
                                            </div>

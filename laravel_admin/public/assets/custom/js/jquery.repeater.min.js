    ...
    $.fn.repeater = function (fig) {
        ...
        $(this).each(function () {
            ...
            var $firstDeleteButton = $filterNested(
                $filterNested($(this).find('[data-repeater-item]'), fig.repeaters).first().find('[data-repeater-delete]'), fig.repeaters
            );
                    ...
                    .each(function () {
                        ...
                        $foreachRepeaterInItem(repeaters, $item, function (nestedFig) {
                            ...
                            setIndexes(
                                ...
                                groupName + '[' + index + ']' + '[' + $repeater.find('[data-repeater-list]').first().data('repeater-list') + ']', nestedFig.repeaters
                            );
                        });
                    });
                });
            ...
            $filterNested($self.find('[data-repeater-create]'), fig.repeaters).click(function () {
                // var items = $items();
                // var isAdd = true;
                // items.find('[name]').each(function () {
                //     if(!$(this).attr('required')){
                //         $(this).attr('required', 'required');
                //     }
                //     if($(this).inputVal() == '' && $(this).attr('required')){
                //         // $(this).valid();
                //         isAdd = false;
                //         return isAdd;
                //     }

...
class Api {
  ...
  static Future<Map<String, dynamic>> sendApiRequest({required Map<String, dynamic> body, required String url}) async {
    try {
      ...
      response = await dio.post(apiUrl, data: formData, options: Options(headers: headers));
